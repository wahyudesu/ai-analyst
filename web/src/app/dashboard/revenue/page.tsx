  ...
  return (
    <main className="p-6">
      <div className="max-w-7xl mx-auto space-y-4">
        ...
        {/* MRR by Plan + NRR Breakdown Row */}
        <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_2.5fr] gap-4">
          {/* MRR by Plan Type */}
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-base">MRR by Plan Type</CardTitle>
            </CardHeader>
            <CardContent>
              {loading ? (
              ...
              ) : data && data.charts.mrrByPlan.length > 0 ? (
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-base">
                Net Revenue Retention (NRR) Breakdown
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                  ...
                  <p className="text-xl font-bold text-green-900 dark:text-green-100">
                    {(data?.metrics.nrr.value || 0).toFixed(1)}%
                  </p>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_2.5fr] gap-4">
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-base">Customer Funnel</CardTitle>
            </CardHeader>
            <CardContent className="h-[200px]">
              ...
              ) : data && data.charts.funnel.length > 0 ? (
                <FunnelChart
                  config={{
                    chartType: "bar",
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-base">Product Engagement</CardTitle>
            </CardHeader>
            <CardContent className="h-[200px]">
              {loading ? (
                <div className="h-full flex items-center justify-center">
                  ...
                  config={{
                    ...
                    data: {
                      series: [
                        {
                          name: "Conversations",
                          data: data.charts.engagement.labels.map(
                            (label, i) => ({
                              x: label,
